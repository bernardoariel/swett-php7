...
<div class="col-lg-6">
 ...
 <div class="box box-primary">
  ...
  <div class="box-body ">
    ...
    <table class="table table-bordered table-striped dt-responsive tablaProductosInicio tablaProductosInicioNJ" width="100%">
      ...
      <tbody>
          <?php 
            ...
            $valor = null;
            $orden = "id";
            $productosIniciales = ControladorProductos::ctrMostrarProductos($item, $valor,$orden);

           foreach ($productosIniciales as $key => $value){
