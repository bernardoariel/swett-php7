  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablaProductos tablaProductosNJ" width="100%">
       ...
       <tbody>
          <?php 
           ...
           foreach ($productos as $key => $value){
              ...
              echo "<td><div class='btn-group'><button class='btn btn-warning btnEditarProducto' idProducto='".$value['id']."' data-toggle='modal' data-target='#modalEditarProducto' title='editar producto'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarProducto' idProducto='".$value['id']."' title='eliminar producto'><i class='fa fa-times'></i></button></div></td>";
               echo '</tr>';
            ...
            <!-- ENTRADA PARA LA nOMBRE -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="nuevoNombre" name="nuevoNombre" placeholder="Ingresar nombre" autocomplete="off" required>
             ...
             <div class="form-group row">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" class="form-control input-lg" id="nuevoPrecioCompra" name="nuevoPrecioCompra" min="0" placeholder="Precio de compra" step="0.01" required>
