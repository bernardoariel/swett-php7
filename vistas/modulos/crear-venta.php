        ...
        <div class="box box-default">
          ...
          <div class="box-body with-border">
            ...
            colocamos todos los input para crear la venta
              ...
              <input type='hidden' id='idClienteForm' name='idClienteForm'>
              <input type='hidden' id='nombreClienteForm' name='nombreClienteForm'>
              <input type='hidden' id='documentoClienteForm' name='documentoClienteForm'>
              <input type='hidden' id='idVendedorForm' name='idVendedorForm' value='<?php echo $_SESSION["id"];?>'>
              <input type="hidden" id="listaProductosForm" name="listaProductosForm">
              ...
              <input type="hidden" id="nuevoTotalVentasForm" name="nuevoTotalVentasForm" value="0">
              <input type="hidden" id="totalVentaForm" name="totalVentaForm" value="0">
            ...
            <button type="submit" class="btn btn-danger btn-block"  style="margin-top: 5px;" id="btn-guardarVenta" disabled>Guardar Venta </button>
              ...
              <div id="adeudaFinal">
                ...
                <center>
                  ...
                  <h3 style="margin-top: 5px;" >Adeuda $0.00</h3>
...
foreach ($clientes as $key => $value) {
  ...
  echo '<tr>';
    ...
    if ($clientes[$key]["idivacliente"]==2){
      ...
      echo '<td><button class="btn btn-primary btnBuscarCliente" data-dismiss="modal"  idCliente='.$clientes[$key]["id"].' nombreCliente="'.$clientes[$key]["nombre"].'" documentoCliente="'.$clientes[$key]["dni"].'">Seleccionar</button></td>';

    }else{

      echo '<td><button class="btn btn-primary btnBuscarCliente" data-dismiss="modal"  idCliente='.$clientes[$key]["id"].' nombreCliente="'.$clientes[$key]["nombre"].'" documentoCliente="'.$clientes[$key]["cuit"].'">Seleccionar</button></td>';
    }
      ...
      <form role="form" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group" id="div-importe">
