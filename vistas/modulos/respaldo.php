...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
      ...
      $nombredia = str_replace($dias_EN, $dias_ES, $dia);
        ...
        $this->backupFile              = strtolower($nombredia).'.sql';
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Haciendo el respaldo</li>
...
$nombre_archivo2=$_SESSION["rutaBK"].'/'.strtolower($nombredia).'.sql.gz';
copy($nombre_archivo, $nombre_archivo2);
?>
