...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Actualizar Bd</li>
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <?php
          ...
          $tabla = array('backup','caja','categorias','clientes','condicioniva','datostitular','empresa','modificacion_precios','nrocomprobante','pagos','parametros','precios','productos','presupuesto','stock','tipocliente','usuarios','vales','ventas');
          ...
          for($i=0; $i<$longitud; $i++){
            ...
            //   echo "Se ha eliminado la tabla - ".$tabla[$i];
            //   echo "<br>";
...
echo "Se ha eliminado el contenido de las tablas  <br>";
          /**
...
if (php_sapi_name() != "cli") {
    echo '</div>';
        ...
        <a href="inicio">
            ...
            <button type="button" class="btn btn-danger form-control btn-block">Iniciar Programa</button>
