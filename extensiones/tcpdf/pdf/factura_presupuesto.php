...
class imprimirFactura{
	...
	public function traerImpresionFactura(){
		...
		$adeuda = number_format($respuestaPresupuesto["adeuda"],2);
		$impuesto = number_format($respuestaPresupuesto["impuesto"],2);
...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="background-color:white; width:110px; text-align:center; color:red"><br><br>PRESUPUESTO <br>$valorVenta</td>
